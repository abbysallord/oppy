...
import { ExternalLink, Check, Copy, Calendar, Award, Globe, ShieldAlert } from 'lucide-react';
...
export default function OpportunityCard({ opportunity, matchScore }: Props) {
  ...
  return (
    <div className="group relative bg-slate-900/60 hover:bg-slate-900/90 border border-slate-800 hover:border-purple-500/40 rounded-2xl p-5 transition-all duration-200 shadow-lg hover:shadow-purple-500/5 flex flex-col justify-between">
      {/* Top Header & Badges */}
      <div>
        ...
        {/* Company Name */}
        <p className="text-sm font-medium text-slate-400 mb-4 flex items-center gap-1.5">
